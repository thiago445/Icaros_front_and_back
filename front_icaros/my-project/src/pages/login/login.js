    ...
    <div className="min-h-screen bg-black flex justify-center items-start pt-10">
      <div className="w-full max-w-2xl px-5">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#FFFFFF] font-sans">
            welcome
          </h1>
        ...
        <button
          ...
          onClick={handleLogin}
        >
          <span className="text-black text-xl font-sans py-3 block font-medium">
            Login
          </span>
        </button>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-[#ECD182]/80 italic text-sm">
            or continue with
          </span>
          <div className="flex-1 border-t border-[#ECD182]/40"></div>
        </div>
