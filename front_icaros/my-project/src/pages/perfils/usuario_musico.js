    ...
    <div className="min-h-screen bg-black text-white">
          ...
          >
            ...
            >
              <div className="p-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">
                        @
                        {userProfile.user.NOME.toLowerCase().replace(/\s/g, '')}
                      </p>
                    </div>
                  </div>
                ...
                >
                  <img
                    src={selectedPost.imageUrl.replace(
                      'www.dropbox.com',
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm">
            {userProfile.musician.COMENTARIO || 'Nenhuma descrição fornecida.'}
          </p>
          <p className="text-sm text-gray-400 mt-1">
            {userProfile.user.GENERO_MUSICAL}
          </p>
        </div>
...
const PostCard = ({
  ...
  return (
    <div
      className="relative group aspect-square bg-gray-900 overflow-hidden post-menu-container"
