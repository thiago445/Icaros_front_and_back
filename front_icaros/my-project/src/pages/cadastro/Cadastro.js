...
const CadastroForm = () => {
    ...
    const obterNomeEmpresa = async (cnpj) => {
        ...
        try {
            const response = await fetch(`https://brasilapi.com.br/api/cnpj/v1/${cnpjFormatado}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if ([1, 2].includes(formData.flagUserType)) {
                const userKey = formData.flagUserType === 2 ? 'userLover' : 'userMusician';
    ...
    return (
        <div className="min-h-screen bg-black flex justify-center items-start pt-10 p-5">
            <div className="w-full max-w-2xl">
                ...
                <h1 className="text-3xl font-bold text-white font-sans mb-8">Cadastro</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {[1, 2].includes(formData.flagUserType) && (
                        <div className="border border-[#ECD182] rounded-lg p-4 space-y-4">
                            ...
                            <div>
                                <label htmlFor="musicalGenre" className="text-white block mb-1">Estilo musical favorito</label>
                                <select
                                    name="musicalGenre"
